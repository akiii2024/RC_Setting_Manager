...
class _SimpleImportPageState extends State<SimpleImportPage> {
  ...
  void _adjustCheckboxesBasedOnFileContent() {
    ...
    setState(() {
      _includeCars = exportedTypes.contains('cars') && _previewData!.cars.isNotEmpty;
      _includeSavedSettings = exportedTypes.contains('savedSettings') && _previewData!.savedSettings.isNotEmpty;
      _includeVisibilitySettings = exportedTypes.contains('visibilitySettings') && _previewData!.visibilitySettings.isNotEmpty;
  ...
  Future<void> _importSelectedData() async {
    ...
    try {
      ...
      await settingsProvider.replacePartialData(
        ...
        savedSettings: _includeSavedSettings ? _previewData!.savedSettings : null,
        visibilitySettings: _includeVisibilitySettings ? _previewData!.visibilitySettings : null,
        isEnglish: _includeLanguageSettings ? (_previewData!.metadata.language == 'en') : null,
      );
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              if (_includeCars) 
                Text('• ${isEnglish ? "Cars" : "車種"} (${_previewData!.cars.length} ${isEnglish ? "items" : "件"})'),
              if (_includeSavedSettings) 
                Text('• ${isEnglish ? "Saved Settings" : "保存された設定"} (${_previewData!.savedSettings.length} ${isEnglish ? "items" : "件"})'),
              if (_includeVisibilitySettings) 
                Text('• ${isEnglish ? "Visibility Settings" : "表示設定"} (${_previewData!.visibilitySettings.length} ${isEnglish ? "cars" : "台分"})'),
            ...
            if (_xmlFiles.isEmpty && !_isLoading) ...[
                    ...
                    children: [
                      ...
                      if (_previewData != null) ...[
                        ...
                        if (_previewData!.metadata.exportDate != null)
                          Text('${isEnglish ? "Export Date" : "エクスポート日"}: ${_previewData!.metadata.exportDate}'),
                        if (_previewData!.metadata.version != null)
                          Text('${isEnglish ? "Version" : "バージョン"}: ${_previewData!.metadata.version}'),
                        const SizedBox(height: 8),
                        Text(
              ...
              if (_previewData != null) ...[
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CheckboxListTile(
                          ...
                          subtitle: Text('${_previewData!.cars.length} ${isEnglish ? "items available" : "件利用可能"}'),
                          value: _includeCars,
                          onChanged: _previewData!.cars.isNotEmpty ? (value) {
                            setState(() {
                        ...
                        CheckboxListTile(
                          ...
                          subtitle: Text('${_previewData!.savedSettings.length} ${isEnglish ? "items available" : "件利用可能"}'),
                          value: _includeSavedSettings,
                          onChanged: _previewData!.savedSettings.isNotEmpty ? (value) {
                            setState(() {
                        ...
                        CheckboxListTile(
                          ...
                          subtitle: Text('${_previewData!.visibilitySettings.length} ${isEnglish ? "cars available" : "台分利用可能"}'),
                          value: _includeVisibilitySettings,
                          onChanged: _previewData!.visibilitySettings.isNotEmpty ? (value) {
                            setState(() {
                        ...
                        CheckboxListTile(
                          ...
                          onChanged: _previewData!.metadata.language != null ? (value) {
                            setState(() {
                ...
                ElevatedButton.icon(
                  ...
                  label: Text(isEnglish ? 'Import Selected Data' : '選択されたデータをインポート'),
                  style: ElevatedButton.styleFrom(
